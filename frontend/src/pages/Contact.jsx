            ...
            <form className="contact-form" onSubmit={handleSubmit}>
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    onChange={(e) =>
                      setProjectData({ ...projectData, firstname: e.target.value })
                    }
                    type="text"
                    id="name"
              ...
              <div className="form-group">
                ...
                <p className="upload-hint">
                  Upload a document or image with your project requirements
                </p>
          ...
          >
            ...
            >
              ...
              <div className="info-items">
                {[
                  { icon: "📧", label: "Email", values: ["madanhiretawanda@gmail.com", "malvinhaparimwi@gmail.com"], hrefs: ["mailto:madanhiretawanda@gmail.com", "mailto:malvinhaparimwi@gmail.com"] },
                  { icon: "📞", label: "Phone", values: ["+263 77 664 2351", "+263 71 488 2607"], hrefs: ["tel:+263776642351", "tel:+263714882607"] },
                  { icon: "📍", label: "Location", values: ["Harare, Zimbabwe"], hrefs: [null] },
                ].map((item, i) => (
                  <motion.div
                    key={i}
                    className="info-item"
                  ...
                  >
                    ...
                    <div>
                      ...
                      {item.values.map((val, j) =>
                        item.hrefs[j] ? (
                          <a key={j} href={item.hrefs[j]} className="info-value">
                            {val}
                          </a>
                        ) : (
                          <p key={j} className="info-value">{val}</p>
                        )
                      )}
                    </div>
                  </motion.div>
            ...
            >
              ...
              <div className="social-links">
                {[
                  { href: "https://github.com/Malvinhaparimwi", label: "GitHub", icon: "github" },
                  { href: "https://linkedin.com/company/tm-access-dev", label: "LinkedIn", icon: "linkedin" },
                ].map((social, i) => (
                  <motion.a
                    key={i}
                    href={social.href}
